...
export const fetchAppointments = () =>
  api.get(
    "https://private-anon-6a5c3c80a7-cfcalendar.apiary-mock.com/mentors/1/agenda"
  );
export const insertAppointment = (payload) => api.post(`/appointment`, payload);
export const updateAppointmentByName = (name, payload) =>
  api.put(`/appointment/${name}`, payload);
